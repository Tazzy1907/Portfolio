  ...
  return (
    <ScrollControls pages={5} damping={0.1}>
        <Scroll>
          ...
          <Html style={{transform: 'translateY(10vh)'}} fullscreen>
            <div id="aboutme">
              <h1>About Me</h1>
          ...
          <Html style={{transform: 'translateY(100vh)'}} fullscreen>
            <div id="projects">
              <h1>Projects</h1>
          ...
          <Html style={{transform: 'translateY(200vh)'}} fullscreen>
            <div id="experience">
              <h1>Experience</h1>
          ...
          <Html style={{transform: 'translateY(300vh)'}} fullscreen>
            <div id="education">
              <h1>Education</h1>
          ...
          <Html style={{transform: 'translateY(400vh)'}} fullscreen>
            <div id="links">
              <h1>Links</h1>
              <a href="">LinkedIn</a> |
              <a href=""> GitHub</a> |
